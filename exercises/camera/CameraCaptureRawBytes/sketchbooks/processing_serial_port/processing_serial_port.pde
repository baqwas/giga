...
final int cameraWidth = 640, cameraHeight = 480; // VGA
/*
final int cameraWidth = 320, cameraHeight = 240; // QVGA
*/
...
void setup() {
  size(640, 480);    // CAMERA_R640x480
  //size(320, 240);  // CAMERA_R320x240
...
void draw() {
  ...
  if(shouldRedraw){    
    ...
    img.resize(640, 480); // CAMERA_R640x480
    // img.resize(320, 240); // CAMERA_R320x240
    image(img, 0, 0);
    shouldRedraw = false;
  }
}
